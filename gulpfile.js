...
const JS_FOLDER_SRC = SRC_FOLDER + "/js/*.*";
const JS_FOLDER_DESTINATION = DESTINATION_FOLDER + "/js";

gulp.task("watch", () => {
    gulp.watch(IMAGE_FOLDER_SRC, ["images"]);
    gulp.watch (JS_FOLDER_SRC , ["/js"]);
...
gulp.task("js", () => {
    gulp
        ...
        .pipe(plumber())
        .pipe(svgo())
        .pipe(gulp.dest(JS_FOLDER_DESTINATION))
});
...
gulp.task("default", gulpSequence(
    "clean",
    ["images", "less", "mustache", "browser-sync", "js"],
    "watch"
));